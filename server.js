...
const server = http.createServer((req, res) => {
    ...
    let filePath =
    // if the content type is html and the url is just a slash, then set the path name using the views directory and set it ti index.html
        contentType === 'text/html' && req.url === '/'
            ...
            : contentType === 'text/html' && req.url.slice(-1) === '/'
                ...
                : contentType === 'text/html'
                    ? path.join(__filename, 'views', req.url)
